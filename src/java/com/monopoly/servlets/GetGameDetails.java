...
public class GetGameDetails extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            List<PlayerDetails> playerDetails = monopoly.getPlayersDetails(gameName);
            ret.put("response", true);
            ret.put("data", new Gson().toJson(playerDetails));
        } catch (GameDoesNotExists_Exception ex) {
            ret.put("response", false);
            ret.put("data", "No game with this name");
        }
